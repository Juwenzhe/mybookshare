		...
		<div class="mobile">
			<div class="mobile-inner">
				<div class="mobile-inner-header">
					...
					<a href="/BookShare/register?lastpage=/BookShare/ideas">注册</a><a href="/BookShare/login?lastpage=/BookShare/ideas">登录</a></c:if>
					<c:if test="${!empty sessionScope.user}">
		...
		<div id="countrySelection">
			<div id="countrySelection-wrapper">
				<ul id="countrySelection-items" style="">
					...
					<li id="ide" class="countrySelection-item active"><a href="/BookShare/ideas">读书心得</a></li>
