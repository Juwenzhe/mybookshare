		...
		<div class="mobile">
			<div class="mobile-inner">
				<div class="mobile-inner-header">
					...
					<a href="/BookShare/register?lastpage=/BookShare/self">注册</a><a href="/BookShare/login?lastpage=/BookShare/self">登录</a></c:if>
					<c:if test="${!empty sessionScope.user}">
		...
		<div id="countrySelection">
			<div id="countrySelection-wrapper">
				<ul id="countrySelection-items" style="">
					...
					<li id="sel" class="countrySelection-item active"><a href="/BookShare/self">个人中心</a></li>
