		...
		<div class="mobile">
			<div class="mobile-inner">
				<div class="mobile-inner-header">
					...
					<a href="/BookShare/register?lastpage=/BookShare/callus">注册</a><a href="/BookShare/login?lastpage=/BookShare/callus">登录</a></c:if>
					<c:if test="${!empty sessionScope.user}">
		...
		<div id="countrySelection">
			<div id="countrySelection-wrapper">
				<ul id="countrySelection-items" style="">
					...
					<li id="callus" class="countrySelection-item active"><a href="/BookShare/callus">联系我们</a></li>
