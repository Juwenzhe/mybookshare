		...
		<div class="mobile">
			<div class="mobile-inner">
				<div class="mobile-inner-header">
					...
					<a href="/BookShare/register?lastpage=/BookShare/order">注册</a><a href="/BookShare/login?lastpage=/BookShare/order">登录</a></c:if>
					<c:if test="${!empty sessionScope.user}">
		...
		<div id="countrySelection">
			<div id="countrySelection-wrapper">
				<ul id="countrySelection-items" style="">
					...
					<li id="ord" class="countrySelection-item active"><a href="/BookShare/order">订单中心</a></li>
